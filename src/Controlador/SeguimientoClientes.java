...
public void actionPerformed(ActionEvent e) {
        ...
        leyenda=_model.registrarAlta("seguimiento_clientes"," null, ' " +_view.txtTipoCartera.getText()+" ',' " +_view.txtFechaMora.getText() +" ', "+_view.txtDiasMora.getText()+" ', "+_view.txtValMora.getText()+" ', "+_view.txtEmail.getText()+" ', "+_view.txtTel_Residencia.getText()+" ', "+_view.txtTel_Trabajo.getText()+" ', "+_view.txtNum_Factura.getText()+" ', "+_view.txtProfesion.getText()+" ', "+_view.txtCiudad.getText()+" ', "+_view.txtFecha_Acuerdo_Uno.getText()+" ', "+_view.txtFecha_Acuerdo_Dos.getText()+" ', "+_view.txtFATres.getText()+" ', "+_view.txtFACuatro.getText()+" ', "+_view.txtId.getText()+" ', "+_view.txtCedula.getText()+" ', "+_view.txtLugar.getText()+" ', "+_view.txtNombreCompleto.getText()+" ', "+_view.txtV_seguro.getText()+" ', "+_view.txtInt_mora.getText()+" ', "+_view.txtSaldo_restante.getText()+" ', "+_view.txtTipo_cobro.getText()+" ', "+_view.txtDirecionResidencial.getText()+" ', "+_view.txtDepartamento.getText()+" ', "+_view.txtAcuerdo_Uno.getText()+" ', "+_view.txtAcuerdo_Dos.getText()+" ', "+_view.txtATres.getText()+" ', "+_view.txtACuatro.getText() );
